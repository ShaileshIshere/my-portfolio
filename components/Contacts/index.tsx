    ...
    return (
        <div id="contact" className="h-[100vh] flex flex-col items-center justify-between relative z-[1] p-8 -mt-[50vh] bg-[#000c1a]">
            ...
            <div className="w-full mx-auto relative z-10">
                <div className={`${Bebas_Neue_Font.className} text-[25vw] md:text-[12vw] leading-[1] md:leading-[15rem] uppercase w-full font-bold text-white absolute top-[5vh] md:top-0 left-4 md:left-16 lg:left-24 opacity-30`}>
                    <div className="flex flex-col md:block">
                        <span className="block md:inline">Let&apos;s </span>
                        <span className="block md:inline">Work</span>
                        <br className='hidden md:block' />
                        <>
                            <span className="block md:hidden text-outline-thin">Together</span>
                            <span className="hidden md:inline text-outline-thick">Together</span>
                        </>
                        <motion.div className="inline-flex">
                            {[0, 1, 2].map((index) => (
                                <motion.span
                                    key={index}
                                    animate={{
                                        opacity: [0, ...(Array(index).fill(0)), ...Array(3 - index).fill(1), 0],
                                    }}
                                    transition={{
                                        duration: 2,
            ...
            {/* Contact Email - Centered on mobile */}
            <div className="w-full flex justify-center md:justify-end md:pr-[6rem]">
                <a href="mailto:shaileshkandari2004@gmail.com" 
                    className="group inline-flex items-center gap-2"
                >
                    <span className={`${Poiret_One_Font.className} text-2xl md:text-4xl mt-[18rem] text-white hover:text-blue-400 transition-colors relative`}>
            ...
            {/* Socials - Already responsive */}
            <div className="w-full flex items-center justify-between pb-8 px-4 md:px-16">
                    ...
                    <div key={index} className="flex items-center group">    
                        <a href={social.link} 
                           ...
                           className="group inline-flex items-center gap-4 transition-transform duration-300">
                            <div className="text-white hover:text-blue-400 transition-colors text-2xl md:text-3xl">
                                {social.icon}
                            </div>
